    ...
    return (
      ...
      >
        <div className="relative flex items-center justify-center mt-0.5">
          ...
          <div
            className={cn(
              'w-4 h-4 rounded border border-dark-border bg-dark-surface transition-all duration-150',
              'group-hover:border-dark-borderHover',
              'peer-checked:bg-brand peer-checked:border-brand peer-checked:text-dark-bg',
              'peer-focus-visible:ring-2 peer-focus-visible:ring-brand/30',
              className
            )}
          >
            <Check className="w-3 h-3 text-dark-bg stroke-[3] opacity-0 peer-checked:opacity-100 transition-opacity" />
          </div>
        </div>
